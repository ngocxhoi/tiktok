<template>
  <div
    ...
    class="fixed flex justify-center pt-14 md:pt-[105px] z-50 top-0 left-0 w-full h-full bg-black/50"
  >
    <div
      class="relative bg-white w-full max-h-[700px] sm:h-[580px] h-[655px] mx-3 p-4 rounded-lg mb-10"
      :class="!uploadedImage ? 'h-[655px]' : 'h-[580px]'"
    >
      <div
        class="flex items-center justify-between w-full p-5 border-b border-b-gray-300"
      >
      ...
      <div id="ButtonSection" class="absolute p-5 left-0 bottom-0 w-full">
        <div
        ...
        >
          <button
            ...
            class="flex items-center border rounded-md px-3 py-[6px] hover:bg-gray-100"
          >
        ...
        <div id="CropperButtons" v-else class="flex items-center justify-end">
          <button
            ...
            class="flex items-center border rounded-md px-3 py-[6px] bg-white hover:bg-gray-100"
          >
            <span class="px-2 font-medium text-[15px]">Cancel</span>
          </button>
